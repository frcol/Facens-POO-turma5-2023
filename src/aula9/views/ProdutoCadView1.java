 ...
 * @author fabio
 */
public class ProdutoCadView1 extends javax.swing.JDialog {
     ...
     */
    public ProdutoCadView1(java.awt.Frame parent, boolean modal, ProdutoView1 main) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProdutoCadView1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProdutoCadView1 dialog = new ProdutoCadView1(new javax.swing.JFrame(), true, null);
